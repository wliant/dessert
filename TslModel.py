...
def TslNetV5(input_shape, no_of_class):
    ...
    layer = Dropout(0.1)(layer)
    layer = Flatten()(layer)
    layer = Dense(1024, activation='relu', bias_regularizer=regularizers.l2(0.05))(layer)
    layer = Dropout(0.5)(layer)
...
def inception_resnet_block(layer, filters, output_shape, scale, activation='relu'):
    ...
    right_branch = conv_block(right_branch, filters_start*2, 3)
...
def TslNetV7(input_shape, no_of_class):
    ...
    layer = inception_resnet_block(layer, 128, output_shape=(37,37), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 128, output_shape=(37,37), scale=0.2, activation='relu')
    layer = reduction_block(layer, 96, 96)
    layer = inception_resnet_block(layer, 320, output_shape=(18,18), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 320, output_shape=(18,18), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 320, output_shape=(18,18), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 320, output_shape=(18,18), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 320, output_shape=(18,18), scale=0.2, activation='relu')
    ...
    layer = inception_resnet_block(layer, 832, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 832, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 832, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 832, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 832, output_shape=(8,8), scale=0.2, activation='relu')
...
def TslNetV8(input_shape, no_of_class):
    visible = Input(shape=input_shape)
    layer = ZeroPadding2D(padding=(3, 3))(visible)
    layer = conv_block(layer, 32, (3,3), (2,2), padding='valid')
    layer = conv_block(layer, 32, (3,3), padding='valid')
    layer = conv_block(layer, 64, (3,3))
    layer = MaxPooling2D((3,3), strides=(2,2))(layer)
    layer = conv_block(layer, 128, (3,3), padding='valid')
    layer = conv_block(layer, 192, (3,3), padding='valid')
    layer = MaxPooling2D((3,3), strides=(2,2))(layer)
    layer = inception_resnet_block(layer, 192, output_shape=(37,37), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 192, output_shape=(37,37), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 192, output_shape=(37,37), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 192, output_shape=(37,37), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 192, output_shape=(37,37), scale=0.2, activation='relu')
    ...
    layer = inception_resnet_block(layer, 384, output_shape=(18,18), scale=0.2, activation='relu')
    layer = reduction_block(layer, 256, 256)
    layer = inception_resnet_block(layer, 896, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 896, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 896, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 896, output_shape=(8,8), scale=0.2, activation='relu')
    layer = inception_resnet_block(layer, 896, output_shape=(8,8), scale=0.2, activation='relu')
