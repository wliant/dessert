...
modelname = 'ca2-pre1-increase-filter'
seed = 7
np.random.seed(seed)
...
def createModel():
    ...
    layer = Conv2D(64, kernel_size = (3,3), activation='relu')(i)
    layer = MaxPooling2D(pool_size=(2,2))(layer)
    layer = BatchNormalization()(layer)
    layer = Conv2D(128, kernel_size=(3,3), activation='relu')(layer)
    layer = MaxPooling2D(pool_size=(2,2))(layer)
    layer = BatchNormalization()(layer)
    layer = Conv2D(128, kernel_size=(3,3), activation='relu')(layer)
    layer = MaxPooling2D(pool_size=(2,2))(layer)
    layer = BatchNormalization()(layer)
    layer = Conv2D(256, kernel_size=(3,3), activation='relu')(layer)
    layer = MaxPooling2D(pool_size=(2,2))(layer)
    layer = BatchNormalization()(layer)
    layer = Conv2D(256, kernel_size=(3,3), activation='relu')(layer)
    layer = MaxPooling2D(pool_size=(2,2))(layer)
